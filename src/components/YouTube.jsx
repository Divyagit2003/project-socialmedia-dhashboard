...
import { faUsers, faChartLine, faEye } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div id='youtube'>
      ...
      <div className='container-fluid bg-light d-flex align-items-center justify-content-center p-3'>
        <FontAwesomeIcon icon={faYoutube} size='3x' className='text-danger' />
      ...
      <div className='container-fluid d-flex flex-wrap justify-content-center mt-2'>
        ...
        <div className='stats-card'>
          <div className='d-flex align-items-center'>
            <FontAwesomeIcon icon={faUsers} size='2x' className='text-danger' />
            <div className='ms-3'>
              <h3>20,154</h3>
        ...
        <div className='stats-card'>
          <div className='d-flex align-items-center'>
            <FontAwesomeIcon icon={faEye} size='2x' className='text-danger' />
            <div className='ms-3'>
              <h3>1,73,035</h3>
        ...
        <div className='stats-card'>
          <div className='d-flex align-items-center'>
            <FontAwesomeIcon icon={faChartLine} size='2x' className='text-danger' />
            <div className='ms-3'>
              <h3>62,986</h3>
